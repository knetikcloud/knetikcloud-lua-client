...
local util_health_api = {}
local util_health_api_mt = {
	__name = "util_health_api";
	__index = util_health_api;
}

local function new_util_health_api(host, basePath, schemes)
	local schemes_map = {}
...
function util_health_api:get_health()
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		path = string.format("%s/health",
			self.basePath);
	})
